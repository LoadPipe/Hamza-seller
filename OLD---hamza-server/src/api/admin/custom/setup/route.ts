import { MedusaRequest, MedusaResponse, Logger, Country, ShippingOptionPriceType } from '@medusajs/medusa';
...
export const POST = async (req: MedusaRequest, res: MedusaResponse) => {
    ...
    const countryRepository: typeof CountryRepository = req.scope.resolve('countryRepository');
    const regionRepository: typeof RegionRepository = req.scope.resolve('regionRepository');
    const fulfillmentRepository: typeof FulfillmentProviderRepository = req.scope.resolve('fulfillmentProviderRepository');
